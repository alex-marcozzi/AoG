...
def is_right_collision_new(entity1: Entity, entity2: Entity):
    ...
    # print(e1_pointer.bottomRight().first)
    # print(e1_next.bottomRight().first)
    while not float_eq(e1_pointer.bottomRight().first, e1_next.bottomRight().first):
        # print(f"from {e1_pointer.bottomRight().first}")
        # print(f"to {e1_next.bottomRight().first}")
        # print(e1_pointer.velocity.first)
        # print(e1_pointer.velocity.second)
