...
def build_level1(window):
    ...
    set_line(level1, Pair(0,2), Pair(0, 3), block, window.width / 15, window.width / 15)
    ...
    set_line(level1, Pair(25,3), Pair(27, 3), block, window.width / 15, window.width / 15)
    set_line(level1, Pair(7,4), Pair(7, 6), block, window.width / 15, window.width / 15)
    set_line(level1, Pair(3,4), Pair(3, 4), block, window.width / 15, window.width / 15)
    set_line(level1, Pair(5,5), Pair(5, 5), block, window.width / 15, window.width / 15)
